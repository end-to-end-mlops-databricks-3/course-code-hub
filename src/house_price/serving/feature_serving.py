...
class FeatureServing:
    ...
    def create_online_table(self) -> None:
        ...
        spec = OnlineTableSpec(
            ...
            run_triggered=OnlineTableSpecTriggeredSchedulingPolicy.from_dict({"triggered": "true"}), #Sets the policy to update the online table when triggered (not on a schedule)
